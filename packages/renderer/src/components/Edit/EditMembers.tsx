          ...
          >
            ...
            <label className="w-6/12 flex items-center justify-center text-zinc-900">
              <input
                ...
                className="focus:outline-2 focus:outline-teal-500 text-center text-zinc-200 bg-zinc-900 p-2 disabled:p-0 disabled:text-zinc-900 disabled:bg-transparent font-light disabled:font-normal block w-11/12 h-full appearance-none leading-normal rounded-sm"
                disabled={editing !== id}
              />
            </label>
            <label className="w-1/12 flex items-center justify-center text-zinc-900">
              <select
                ...
                name="congregated"
                onChange={(event) => handleChange(event, index)}
                className="focus:outline-2 focus:outline-teal-500 cursor-pointer disabled:cursor-default text-center text-zinc-200 bg-zinc-900 p-2 disabled:p-0 disabled:text-zinc-900 disabled:bg-transparent font-light disabled:font-normal block w-full h-full disabled:appearance-none leading-normal rounded-sm"
                disabled={editing !== id}
              >
                <option disabled value="">É Congregado?</option>
                <option title="true" value="true">Sim</option>
                <option title="false" value="false">Não</option>
              </select>
            </label>
          </EditForm>
        ))}
